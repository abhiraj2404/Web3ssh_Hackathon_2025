        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <div className="flex items-center gap-4 mb-4 md:mb-0">
              <h2 className="text-2xl font-bold text-gray-900">{filteredEvents.length} Events Found</h2>
          ...
          {filteredEvents.length === 0 ? (
            ...
            <div className="text-center py-16 text-lg text-gray-500">Loading events...</div>
          ) : error ? (
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center text-white space-y-6">
            ...
            <p className="text-purple-100">Get notified when new events are created in your area</p>
