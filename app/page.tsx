          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Create memorable events, manage registrations, and reward attendees with unique NFTs. 
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Join thousands of event organizers who are already using blockchain technology 
              to create more engaging and trustworthy events.
            </p>
